...
namespace Infonet.CStoreCommander.WebApi.Helpers
{
    ...
    public sealed class NLogger : ITraceWriter
    {
        ...
        /// <summary>
        /// This method is used to trace logging at different levels
        /// </summary>
        /// <param name="message">Message to be logged</param>
        /// <param name="level">Level of the message to be logged</param>
        public void Trace(string message, TraceLevel level)
        {
            if (level != TraceLevel.Off)
            {
                Logger[level](Convert.ToString(message) + Environment.NewLine);
            }
        }
        #endregion
